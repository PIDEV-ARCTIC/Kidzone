...
@Component({
  selector: 'app-encaissementc',
  templateUrl: './encaissementc.component.html',
  styleUrls: ['./encaissementc.component.css']
})
export class EncaissementcComponent implements OnInit {
